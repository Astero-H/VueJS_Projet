<template>
  <div id="app">
    ...
    <div>
      <p>New movie</p>
      <br>Title :<input type="text" v-model="movie_to_add.title">
      <br>Year :<input type="text" v-model="movie_to_add.year">
      <br>Synopsys :<textarea v-model="movie_to_add.synopsys"></textarea>
      <br> 
      <form action="/profile" method="post" enctype="multipart/form-data">
        <input type="file" name="avatar" />
    </form>
      <br><button v-on:click="newmovie2">Add</button>
    ...
    <p v-if="movie_to_edit">New movie
      <br>Title :
